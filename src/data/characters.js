...
export const characters = {
  mama: {
    ...
    color: '#FF9AA2',
    messages: [
      '¡Ay, qué bien, Paula! ¡Qué bueno que curaste al {animal} con {treatment}! Estoy muy orgullosa de ti. ❤️',
  ...
  bibi: {
    ...
    messages: [
      ...
      '¿Sabías que el {animal} te va a dibujar un retrato? Porque eres su heroína favorita. 🖼️',
